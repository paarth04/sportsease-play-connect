    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        <Link to="/" className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">SportsEase</h1>
            <p className="text-xs text-muted-foreground hidden sm:block">Play • Connect • Grow</p>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-4 flex-1 max-w-2xl mx-8">
          <nav className="flex items-center space-x-1">
            ...
            <Link to="/player-matching">
              <Button variant="ghost" size="sm">AI Matching</Button>
            </Link>
          </nav>
            ...
            <>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuItem onClick={() => navigate(userRole === "owner" ? "/owner/dashboard" : "/dashboard")}>
